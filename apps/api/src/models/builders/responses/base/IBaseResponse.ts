...
type IBaseResponse<D> = {
     ...
     * @description Numeric status copied from the concrete response builder that produced this object.
     */
    ...
    | {
           ...
           * @description Payload returned to the client for a successful operation.
    ...
    | {
           ...
           * @description Payload describing why the operation failed.
