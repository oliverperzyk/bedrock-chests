...
class EnvironmentVariablesDataManager {
     ...
     * @description Reads the named variable from Bun's env object and optionally requires it to be set.
     ...
     * @description Parses the named variable with Number.parseFloat and rejects non-numeric values.
     * @param variableName - The name of the environment variable.
     * @param required - Whether the environment variable is required.
     * @returns The value of the environment variable.
     */
     ...
     * @description Parses the named variable as an integer and requires it to be between 1 and 65535.
     * @param variableName - The name of the environment variable.
     * @param required - Whether the environment variable is required.
     * @returns The value of the environment variable.
     */
     ...
     * @description Accepts a case-insensitive "true" or "false" after trimming whitespace.
     * @param variableName - The name of the environment variable.
     * @param required - Whether the environment variable is required.
     * @returns The value of the environment variable.
     */
